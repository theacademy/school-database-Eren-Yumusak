...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(DISTINCT cs.student_id) as numStudents FROM course c JOIN course_student cs ON c.cid = cs.course_id GROUP BY c.courseCode, c.courseDesc ORDER BY c.courseCode";
